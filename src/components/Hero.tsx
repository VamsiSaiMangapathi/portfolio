  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute w-80 h-80 bg-cyan-500/10 rounded-full blur-3xl animate-pulse bottom-10 right-10 animation-delay-2000"></div>
        <div className="absolute w-64 h-64 bg-purple-500/10 rounded-full blur-3xl animate-pulse top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animation-delay-4000"></div>
      </div>
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-4 h-4 bg-blue-400/30 rotate-45 animate-float"></div>
        <div className="absolute top-40 right-32 w-6 h-6 bg-cyan-400/30 rounded-full animate-float-delayed"></div>
        <div className="absolute bottom-32 left-40 w-5 h-5 bg-purple-400/30 rotate-12 animate-float-slow"></div>
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex justify-center space-x-8 mb-16 animate-fade-in-up animation-delay-1500">
              ...
              <a
                ...
                className="group p-4 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all duration-300 transform hover:scale-110 hover:-translate-y-2 hover:shadow-lg hover:shadow-cyan-400/25"
              >
